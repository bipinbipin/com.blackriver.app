...
<head>
    ...
    <c:url value="/static/css/bootstrap_themes/bootstrap_darkly.min.css" var="bootstrap_theme" />
    <link href="${bootstrap_theme}" rel="stylesheet" media="screen"/>

    <c:url value="/static/css/blackriver.css" var="bootstrap_custom" />
    <link href="${bootstrap_custom}" rel="stylesheet" media="screen"/>


    <title>Black River Retail Planning Application</title>
</head>
<body>